 ...
 */
define(["require", "exports", "@azure/msal-browser", "./message-helper"], function (require, exports, msal_browser_1, message_helper_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.dialogFallback2 = exports.dialogFallback = void 0;
    ...
    const publicClientApp = new msal_browser_1.PublicClientApplication(msalConfig);
    ...
    function handleResponse(response) {
        if (response.tokenType === "id_token") {
            ...
            Office.context.ui.messageParent(JSON.stringify({ status: "success", result: response, accountId: response.account.homeAccountId }));
        }
    }
    async function dialogFallback(callback) {
    ...
    exports.dialogFallback = dialogFallback;
    async function dialogFallback2(callback) {
        // // Attempt to acquire token silently if user is already signed in.
        // if (homeAccountId !== null) {
        //   const result = await publicClientApp.acquireTokenSilent(loginRequest);
        //   if (result !== null && result.accessToken !== null) {
    ...
    exports.dialogFallback2 = dialogFallback2;
    ...
    async function processMessage(arg) {
        ...
        if (messageFromDialog.status === "success") {
            ...
            if (messageFromDialog.error) {
                (0, message_helper_1.showMessage)(JSON.stringify(messageFromDialog.error.toString()));
            }
            else if (messageFromDialog.result) {
                (0, message_helper_1.showMessage)(JSON.stringify(messageFromDialog.result.errorMessage.toString()));
            }
        }
    }
